...
from src.data.components.fastmri_transform import VarNetDataTransform
...
def train(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    train_transform = VarNetDataTransform(cfg.data.challenge, mask_func=mask, use_seed=False, noisy_label=cfg.transforms.noisy_label)
...
@hydra.main(version_base="1.3", config_path="../configs", config_name="finetuning.yaml")
